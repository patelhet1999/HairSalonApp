...
class CompletedAppointmentDetailsScreen extends StatefulWidget {
  ...
  CompletedAppointmentDetailsScreen({Key? key, required this.isMale,}) : super(key: key);

  @override
  State<CompletedAppointmentDetailsScreen> createState() => _CompletedAppointmentDetailsScreenState();
}

class _CompletedAppointmentDetailsScreenState extends State<CompletedAppointmentDetailsScreen> {
  @override
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: Center(child: Text("Completed",style: TextStyle(color: Colors.blue, fontSize: 14, fontWeight: FontWeight.w700),)),
                          ),
                        ],
                      ),
