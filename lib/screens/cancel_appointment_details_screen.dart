...
class CancelAppointmentDetailsScreen extends StatefulWidget {
  bool isMale;

  CancelAppointmentDetailsScreen({Key? key, required this.isMale,}) : super(key: key);

  @override
  State<CancelAppointmentDetailsScreen> createState() => _CancelAppointmentDetailsScreenState();
}

class _CancelAppointmentDetailsScreenState extends State<CancelAppointmentDetailsScreen> {
  @override
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: Center(child: Text("Cancelled",style: TextStyle(color: Colors.blue, fontSize: 14, fontWeight: FontWeight.w700),)),
                          ),
                        ],
                      ),
