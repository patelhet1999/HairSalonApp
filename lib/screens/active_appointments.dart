...
import 'acitive_appointment_details_screen.dart';

class ActiveAppointmentsScreen extends StatefulWidget {
  bool isMale;
  ActiveAppointmentsScreen({Key? key, required this.isMale,}) : super(key: key);

  @override
  State<ActiveAppointmentsScreen> createState() => _ActiveAppointmentsScreenState();
}

class _ActiveAppointmentsScreenState extends State<ActiveAppointmentsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: GestureDetector(
        onTap: (){
          Navigator.push(context, MaterialPageRoute(builder: (context) => ActiveAppointmentDetailsScreen(IsMale: widget.isMale,),));
        },
        child: Container(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("IN PROCESS",style: TextStyle(color: Colors.blue, fontSize: 14, fontWeight: FontWeight.w700),),
                      Container(
                        height: 35,
                        width: 100,
                        decoration: BoxDecoration(
